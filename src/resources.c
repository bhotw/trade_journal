...
# define SECTION __attribute__ ((section (".gresource.journalapp"), aligned (sizeof(void *) > 8 ? sizeof(void *) : 8)))
#else
# define SECTION
#endif

static const SECTION union { const guint8 data[1425]; const double alignment; void * const ptr;}  journalapp_resource_data = {
  ...
  "\001\000\114\000\260\000\000\000\264\000\000\000\036\321\231\201"
  "\000\000\000\000\264\000\000\000\014\000\114\000\300\000\000\000"
  "\304\000\000\000\313\305\300\101\004\000\000\000\304\000\000\000"
  "\015\000\166\000\330\000\000\000\136\002\000\000\357\235\354\164"
  "\004\000\000\000\136\002\000\000\011\000\166\000\150\002\000\000"
  "\202\005\000\000\313\243\246\071\001\000\000\000\202\005\000\000"
  "\003\000\114\000\210\005\000\000\220\005\000\000\057\000\000\000"
  "\001\000\000\000\152\157\165\162\156\141\154\137\141\160\160\057"
  "\004\000\000\000\147\145\141\162\163\055\155\145\156\165\056\165"
  "\151\000\000\000\000\000\000\000\166\001\000\000\000\000\000\000"
  ...
  "\156\144\157\167\056\165\151\000\012\003\000\000\000\000\000\000"
  "\074\077\170\155\154\040\166\145\162\163\151\157\156\075\042\061"
  "\056\060\042\040\145\156\143\157\144\151\156\147\075\042\125\124"
  "\106\055\070\042\077\076\012\074\151\156\164\145\162\146\141\143"
  "\145\076\074\164\145\155\160\154\141\164\145\040\143\154\141\163"
  "\163\075\042\112\157\165\162\156\141\154\101\160\160\127\151\156"
  ...
  "\141\164\141\142\154\145\075\042\171\145\163\042\076\124\162\141"
  "\144\145\040\112\157\165\162\156\141\154\074\057\160\162\157\160"
  ...
  "\164\150\042\076\066\060\060\074\057\160\162\157\160\145\162\164"
  "\171\076\074\160\162\157\160\145\162\164\171\040\156\141\155\145"
  "\075\042\144\145\146\141\165\154\164\055\150\145\151\147\150\164"
  ...
  "\154\145\142\141\162\042\076\074\157\142\152\145\143\164\040\143"
  ...
  "\074\143\150\151\154\144\040\164\171\160\145\075\042\164\151\164"
  "\154\145\042\076\074\157\142\152\145\143\164\040\143\154\141\163"
  "\163\075\042\107\164\153\123\164\141\143\153\123\167\151\164\143"
  "\150\145\162\042\040\151\144\075\042\164\141\142\163\042\076\074"
  ...
  "\057\143\150\151\154\144\076\074\143\150\151\154\144\040\164\171"
  "\160\145\075\042\145\156\144\042\076\074\157\142\152\145\143\164"
  "\040\143\154\141\163\163\075\042\107\164\153\115\145\156\165\102"
  "\165\164\164\157\156\042\040\151\144\075\042\147\145\141\162\163"
  ...
  "\171\051\165\151\057\000\000\000\002\000\000\000\003\000\000\000"
  "" };

static GStaticResource static_resource = { journalapp_resource_data.data, sizeof (journalapp_resource_data.data) - 1 /* nul terminator */, NULL, NULL, NULL };

G_MODULE_EXPORT
GResource *journalapp_get_resource (void);
GResource *journalapp_get_resource (void)
{
...
#ifdef G_DEFINE_CONSTRUCTOR_NEEDS_PRAGMA
#pragma G_DEFINE_CONSTRUCTOR_PRAGMA_ARGS(journalappresource_constructor)
#endif
G_DEFINE_CONSTRUCTOR(journalappresource_constructor)
#ifdef G_DEFINE_DESTRUCTOR_NEEDS_PRAGMA
#pragma G_DEFINE_DESTRUCTOR_PRAGMA_ARGS(journalappresource_destructor)
#endif
G_DEFINE_DESTRUCTOR(journalappresource_destructor)

#else
#warning "Constructor not supported on this compiler, linking in resources will not work"
#endif

static void journalappresource_constructor (void)
{
  g_static_resource_init (&static_resource);
}

static void journalappresource_destructor (void)
{
